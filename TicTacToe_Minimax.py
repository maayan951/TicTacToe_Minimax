...
def printRules():
    ...
    print('   4, 5, 6 ')
    print('   7, 8, 9 ')
    print('2. X is the first player and O is the second player.')
    ...
    print('5. Players can only enter the squares that are empty.')
    print('6. The first player to enter a square is X, the second player is O.')
    print('7. The game ends when a player wins or the board is full.')
    print('\nGood luck!\n\n')
